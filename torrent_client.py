...
class TorrentClient:
    def __init__(self):
        ...
        self.txt = {
            "en": {
                ...
                "cache_cleared": "Reset complete. Restarting...",
            ...
            "de": {
                ...
                "lang": "Sprache",
                "clear_cache": "Cache leeren / Reset",
                "cache_cleared": "Reset komplett. Neustart...",
                "magnet_input": "Magnet Link",
    ...
    def settings_menu(self):
        while True:
            ...
            opts = [f"Path: {c.get('default_download_path')}", f"{self.t('limit')}: {c.get('download_limit')} KB/s", f"{self.t('lang')}: {lang_label}", self.t("clear_cache"), f"{self.t('refresh_rate')}: {c.get('refresh_rate')}s"]
            ...
            if idx == 3:
                if self.ui.confirm("Are you sure? This will reset all data!", animate=True):
                    if c.clear_cache():
            ...
            if idx == 4:
                ...
                if inp.isdigit(): c.set("refresh_rate", int(inp))